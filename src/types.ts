...
export interface TableCard extends BaseCard {
  ...
  /** Столбцы, где числа 0–4 показываются значками-«пирогами» (матрица
   *  компетенций). Выровнено по headers; отсутствующие элементы = false.
   *  Значения вне 0–4 в таком столбце остаются числом. */
  iconColumns?: boolean[];
}
