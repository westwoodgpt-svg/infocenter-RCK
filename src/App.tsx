        ...
        >
          ...
          <div className="space-y-1.5 text-xs text-[#a1a1aa] leading-relaxed">
            ...
            <p>
              ...
              таблицы (ячейки можно выделять цветом) и события. Счётчик дней работает и в одиночной карточке
              «Событие», и в списке событий: для каждого события выбирается отсчёт до даты или обратный счёт
              («сколько дней прошло»).
            </p>
            {isShared && (
              <p>
